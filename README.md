...
## Pre-requitesites
1. [Git](https://git-scm.com/downloads) client installed. 
    - Verify git client installed properly by executing this command in command line `git --version`
2. [NodeJS](https://nodejs.org/en/) 8+ installed
    - You can verify if nodejs is installed properly by executing this command in command line `node --version`
