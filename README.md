...
There also are some extra configurations needed to the cypress project for test scheduling to work in qTest Launch and Universal Agent against your actual Cypress project. So please make sure you follow the section **Schedule and Kick Off Selected Tests in Cypress** at the end of this document.
